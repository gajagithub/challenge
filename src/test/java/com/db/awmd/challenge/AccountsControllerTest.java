...
public class AccountsControllerTest {
  ...
  //Test case for transferAmount controller Service
  @Test
  public void amounttransfer() throws Exception {
    this.mockMvc.perform(post("/v1/accounts/amounttransfer").contentType(MediaType.APPLICATION_JSON)
      .content("{\"accountFromId\":\"1234\",\"accountToId\":\"123\",\"amount\":1000}")).andExpect(status().isCreated());

    Account account = accountsService.getAccount("1234");
